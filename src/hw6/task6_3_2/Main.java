...
class Director {
    ...
    public void setBuilders(CarBuilder carBuilder, EngineBuilder engineBuilder,
...
class Main {
    public static void main(String[] args) {
        ...
        director.setBuilders(carBuilder, engineBuilder, transmissionBuilder, wheelsBuilder);
